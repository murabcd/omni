...
export function buildSystemPrompt(options: SystemPromptOptions): string {
	return [
		...
		"Memory: Use memory_read to recall prior context and memory_append to store durable facts in memory/core.md (details in memory/notes.md; daily logs in memory/YYYY-MM-DD.md).",
